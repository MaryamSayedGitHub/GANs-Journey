"""
02_Vallina_GAN/train.py
------------------------
تدريب الـ Vanilla GAN على MNIST بالـ min-max game الأساسي:
...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        for images, _ in loop:
            ...
            # ---------------- تدريب G ----------------
            # عايزين D(fake) تقرب من 1 (يعني نخدع الـ Discriminator)
    ...
    plot_losses(history, f"{args.output_dir}/loss_curve.png", title="Vanilla GAN Losses")
